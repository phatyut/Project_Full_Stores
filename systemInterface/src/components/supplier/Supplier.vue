...
<div class="relative w-full h-auto flex flex-col px-4 pt-2 gap-2" >
    <div class="relative py-2  w-full h-auto flex justify-between rounded-md">
        <div class="font-bold text-[18px]">Supplier</div>
        <div>
            <button class="text-[14px] font-semibold shadow-[0px_1px_2px] p-2 rounded-md ">Add Supplier</button>
        </div>
    </div>
        ...
        <table class="min-w-full shadow-[0px_0px_1px] shadow-amber-400 p-2 rounded-md overflow-hidden ">
            <thead class="  w-full ">
                <tr class="*:text-[13px] *:py-3 *:font-bold bg-amber-600/50 ">
                    <th class=" py-2 text-start pl-2 w-[10%]">No</th>
                    <th class=" py-2 text-start pl-2 w-[15%] "> Business name</th>
                    <th class=" py-2 text-start pl-2 w-[10%]">Name</th>
                    <th class=" py-2 text-start pl-2 w-[10%]">Phone</th>
                    <!-- <th class=" py-2 text-start pl-2  w-[10%]">Sex</th> -->
                    <th class=" py-2 text-start pl-2 w-[15%] ">Address</th>
