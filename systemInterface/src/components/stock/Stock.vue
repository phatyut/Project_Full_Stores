<template>
<div class="relative w-full h-auto flex flex-col px-4 pt-2 gap-2" >
    <div class="relative py-2  w-full h-auto flex justify-between rounded-md">
        <div class="font-bold text-[18px]">Stock</div>
        <div class="flex gap-2">
            <button class="text-[14px] font-semibold shadow-[0px_1px_2px] px-2 py-1 rounded-md ">Add Item </button>
        </div>
    </div>
    ...
    <div class="relative h-full rounded-md shadow-[0px_0px_5px] gap-4 flex flex-col p-3 " style="position: relative;">
        <div class="relative flex justify-between items-center ">
            ...
            <div>
                <input type="text" class="md:w-[250px] h-[40px] px-2  outline outline-none shadow-[0px_0px_3px] shadow-amber-300 rounded-md" placeholder="Search product code...">
            </div>
        </div>
        <table class="min-w-full shadow-[0px_0px_1px] shadow-amber-400 p-2 rounded-md overflow-hidden ">
            <thead class="  w-full ">
                <tr class="*:text-[13px] *:py-3 *:font-bold bg-amber-600/50 ">
                    <th class=" py-2 text-start pl-2 w-[5%]">No</th>
                    <th class=" py-2 text-start pl-2 w-[10%]">Product code</th>
                    <th class=" py-2 text-start pl-2 w-[10%] "> Batch ID</th>
                    <!-- <th class=" py-2 text-start pl-2 w-[10%]">Category</th> -->
                    <th class=" py-2 text-start pl-2  w-[10%]">Location</th>
                    <th class=" py-2 text-start pl-2 w-[15%] ">Quantity </th>
                    <!-- <th class=" py-2 text-start pl-2  w-[10%] ">Role</th> -->
                    <!-- <th class=" py-2 text-start pl-2 w-[10%]">Start Work</th> -->
