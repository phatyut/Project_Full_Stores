    ...
    <div class="relative w-full h-auto gap-4 p-4  ">             
                ...
                <div class="relative flex flex-col">
                      <div class="relative w-full md:grid md:grid-cols-3 flex justify-between h-auto inset-shadow-[0px_-1px_0px_rgba(255,255,0,.5)] py-3">
                          <div class="relative w-5 h-5 bg-amber-400">img</div>
                          <div class="relative w-5 h-5  ring-1">ProductOne</div>
                          <div class="relative w-5 h-5 ">234</div>
                      </div>
                      <div class="relative w-full md:grid md:grid-cols-3 flex justify-between h-auto inset-shadow-[0px_-1px_0px_rgba(255,255,0,.5)] py-3">
                          <div class="relative w-5 h-5 bg-amber-400">img</div>
                          <div class="relative w-5 h-5  ring-1">ProductOne</div>
                      ...
                      <div class="relative w-full md:grid md:grid-cols-3 flex justify-between h-auto inset-shadow-[0px_-1px_0px_rgba(255,255,0,.5)] py-3">
                          <div class="relative w-5 h-5 bg-amber-400">img</div>
                          <div class="relative w-5 h-5  ring-1">Product One</div>
                          <div class="relative w-5 h-5 ">234</div>
                      </div>
                </div>
            </div>
